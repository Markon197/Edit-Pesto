...
export default function Home() {
  ...
  // Sync with whatever the blocking init script (in layout.tsx) already set
  // on <html> before hydration, so there's no light-mode flash and no
  // mismatch between the toggle label and the actual applied theme.
  useEffect(() => {
    ...
    <>
      <div className="masthead">
        <div className="masthead-left">
          ...
          <div className="tag">Final proofing pass before publishing</div>
        </div>
        <button
